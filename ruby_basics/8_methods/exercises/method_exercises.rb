...
def lucky_number(x = 7)
    return "Today's lucky number is #{x}"
end
...
def ascii_code(x)
    ...
    return 'Input Error' if x.length != 1
end
...
def pet_pun(x)
    ...
    when 'dog'
        ...
        puts "I think #{x}s have pet-tential!"
    end
end
...
def twenty_first_century?(x)
    return x.between?(2001, 2100)
end
